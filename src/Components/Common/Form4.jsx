...
function Form4({
     ...
     const location = useLocation();
      ...
      useEffect(() => {
        ...
        setFormData((prevData) => {
          const updatedData = {
            ...prevData,
            propertyAlloted: rowData.propertyAlloted || "",
            allotmentMode:rowData.allotmentMode || "",
            billing:rowData.billing || "",
            payMode:rowData.payMode || "",
            allotmentNumberLetter:rowData.allotmentNumberLetter || "",
  ...
  const handleInputValidation = (e) => {
    ...
    else if (name === "receiptAmount" || name === "allotmentNumberLetter") {
    ...
    else if (name === "allotmentNumberLetter") {
      if (/^0/.test(value)) {
        error = "This field cannot start with 0";
        validValue = validValue.replace(/^0+/, ""); 
        isValid = false;
      }
      if (/\./.test(value)) {
    ...
    const dataToSend = {
      hierarchyData: {
        ...
        additionalFields: {
          ...
          propertyAlloted: formData.propertyAlloted,
          allotmentMode: formData.allotmentMode,
          ...
          allotmentNumberLetter: formData.allotmentNumberLetter,
        ...
        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
          <div className="-mx-3 md:flex mb-6">
            <div className="md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <select
                className="w-full bg-gray-200 border text-black py-3 px-4 rounded"
                name="propertyAlloted"
                value={formData.propertyAlloted}
                onChange={handleInputValidation}
                onBlur={handleInputValidation}
                onFocus={handleFocus}
              >
                <option value="" disabled hidden>
                  Select Allotment Property
                </option>
                <option value="Land">Land</option>
                <option value="Property">Property</option>
                <option value="Other">Other</option>
              </select>
              {errors.propertyAlloted && (
            ...
            <div className="md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <select
                className="w-full bg-gray-200 border text-black py-3 px-4 rounded"
                name="allotmentMode"
                value={formData.allotmentMode}
                onChange={handleInputValidation}
                onBlur={handleInputValidation}
                onFocus={handleFocus}
              >
                <option value="" disabled hidden>
                  Select Mode of Allotment
                </option>
                <option value="Lease">Lease</option>
                <option value="Sale">Sale</option>
                <option value="Other">Other</option>
              </select>
              {errors.allotmentMode && (
                <p className="text-red-500 text-xs italic">
                  {errors.allotmentMode}
                </p>
              )}
          ...
          <div className="-mx-3 md:flex mb-6">
            <div className="md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              {errors.payMode && (
                <p className="text-red-500 text-xs italic">{errors.payMode}</p>
              )}
            </div>
            <div className="md:w-1/2 px-3 mb-6 md:mb-0">
              <label className="tracking-wide text-black text-xs font-bold mb-2">
                Fees Charged to (Name)
              </label>
              <input
                name="billing"
                ...
                type="text"
                placeholder="Fees Charged to (Name)"
                maxLength={45}
              />
              {errors.billing && (
          ...
          <div className="-mx-3 md:flex mb-6">
            <div className="md:w-1/2 px-3 mb-6 md:mb-0">
              <label className="tracking-wide text-black text-xs font-bold mb-2">
                Letter Allotment Number
              </label>
              <input
                name="allotmentNumberLetter"
                value={formData.allotmentNumberLetter}
                onChange={handleInputValidation}
                onBlur={handleInputValidation}
                onFocus={handleFocus}
                className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                type="text"
                maxLength={20}
                placeholder="Letter Allotment Number"
              />
              {errors.allotmentNumberLetter && (
                <p className="text-red-500 text-xs italic">
                  {errors.allotmentNumberLetter}
                </p>
              )}
