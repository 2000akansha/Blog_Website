  ...
  const [isSubmitting, setIsSubmitting] = useState(false);
    ...
    useEffect(() => {
      ...
      setFormData((prevData) => {
        const updatedData = {
          ...prevData,
          loanAssistance: rowData.loanAssistance || "",
    ...
    const handleAddMore = (fieldName) => {
      setFields((prevFields) => {
        ...
        if (rowData) {
          if (fieldName === "receiptAmount") {
            updatedFields.receiptAmount = prevFields.receiptAmount.map((advance, index) =>
              index === 0
                ? {
                    ...advance,
      ...
      setFields((prevFields) => {
        ...
        if (!rowData) {
          ...
          if (updatedFields[fieldName]?.[0]?.paymentDetails) {
            const updatedPaymentDetails = [...updatedFields[fieldName][0].paymentDetails];
    ...
    const dataToSend = {
      hierarchyData: {
        ...
        additionalFields: {
          ...
          loanAssistance: formData.loanAssistance,
          ...
          <div className="-mx-3 md:flex mb-6">
              ...
              <select
                className={`w-full bg-gray-200 text-black border ${
                  errors.loanAssistance ? "border-red-500" : "border-gray-200"
              ...
              >
                <option value="" disabled hidden>
                  Select Loans/Assistance
                </option>
                <option value="Loans from UP Government">Loans from UP Government</option>
                <option value="Loans From Other Financial Institutions">Loans From Other Financial Institutions</option>
                <option value="Loans From Other IDA">Loans From Other IDA</option>
                <option value="Loans From Central Government">Loans From Central Government</option>
              </select>
              {errors.loanAssistance && (
                <p className="text-red-500 text-xs italic">
                  {errors.loanAssistance}
                </p>
              )}
            </div>
            <div className="flex flex-col md:w-1/2 px-3" style={{marginTop:"4px"}}>
              <label className="tracking-wide text-black text-xs font-bold mb-2">
                Receipt Date
              </label>
              <CustomDatePicker
